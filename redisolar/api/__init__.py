...
#from redisolar.core.connections import get_redis_connection as get_connection
from redisolar.core.connections import get_redis_timeseries_connection as get_connection
...
#from redisolar.dao.redis import MetricDaoRedis as Mdr
from redisolar.dao.redis import MetricDaoRedisTimeseries as Mdr
...
def configure(app):
    ...
    redis_client = get_connection(app.config['REDIS_HOST'], app.config['REDIS_PORT'])
    ...
    api.add_resource(MetricsResource,
                     '/metrics/<int:site_id>',
                     resource_class_args=(Mdr(redis_client, key_schema), ))
